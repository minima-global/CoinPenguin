...
const KBar = ({ children }: IProps) => {
  ...
  const actions: Action[] = [
    ...
    },
    {
      ...
      name: "Retrieve Coins",
      shortcut: ["r"],
      keywords: "retrieve coins, update coins database",
      perform: () => promptCoinRetrieval(),
      subtitle:
        "Retrieve X coins from the Syncblocks and update your Coin database",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    },
    {
      ...
      name: "Archive Info",
      shortcut: ["a"],
      keywords: "archive information",
      perform: () => promptArchiveInfo(),
      subtitle: "Get information about your archive",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
